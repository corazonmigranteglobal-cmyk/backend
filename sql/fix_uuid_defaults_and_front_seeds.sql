...
-- 1) Reparar defaults de UUID para tablas pivote que fallan en seeds.
...
-- 2) Reparar defaults de UUID faltantes en tablas nuevas usadas por front/content/ads/homepage.
DO $$
DECLARE
  r RECORD;
BEGIN
...
-- 3) Eliminar duplicados antes de crear índices únicos idempotentes.
...
-- 4) Crear unicidad real para que ON CONFLICT DO NOTHING sea correcto.
